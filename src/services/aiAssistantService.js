...
const navigationReply = (message) => {
    const rules = [
        ...
        { pattern: /我的题库|学生题库|我的题目/, reply: '「我的题库」在左侧菜单，可以管理自己收集和导入的题目，也可以把好题共享到同专业社区。' },
        { pattern: /社区题目|同专业社区|共享题目|同学分享/, reply: '「同专业社区」在我的题库 → 社区题目，可以浏览同专业同学分享并通过审核的题目，也支持带答案导出。' },
        { pattern: /审核队列|学生版主|共享审核/, reply: '「审核队列」在我的题库 → 审核队列，学生版主可以审核同专业同学提交的共享题目。' },
    ...
    return '您可以通过左侧导航进入「答题练习」「自适应练习」「我的学习分析」「我的题库」「个人中心」「用户反馈」；也可以问我“怎么开始做题”。';
};
